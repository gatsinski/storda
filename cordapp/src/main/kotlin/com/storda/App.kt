...
class TemplateApi(val rpcOps: CordaRPCOps) {
    // Accessible at /api/storda/templateGetEndpoint.
    @GET
...
class TemplateWebPlugin : WebServerPluginRegistry {
    ...
    override val staticServeDirs: Map<String, String> = mapOf(
        // This will serve the templateWeb directory in resources to /web/storda
        "storda" to javaClass.classLoader.getResource("templateWeb").toExternalForm()
    )
}
