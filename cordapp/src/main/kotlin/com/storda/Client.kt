...
private class TemplateClient {
    companion object {
        ...
        private fun logState(state: StateAndRef<PurchaseState>) = logger.info("{}", state.state.data)
    }
    ...
    fun main(args: Array<String>) {
        ...
        // Can be amended in the com.storda.MainKt file.
        val proxy = client.start("user1", "test").proxy

        // Grab all existing TemplateStates and all future TemplateStates.
        val (snapshot, updates) = proxy.vaultTrack(PurchaseState::class.java)
